...
if(isset($_SESSION['ID'])) : $ID = $_SESSION["ID"]; endif;
$ID = $_REQUEST["ID"];
...
$(document).ready(function() {
    ...
    $('#submit-edit').on('click', function() {
        ...
        $.ajax({
            method: 'POST',
            url: 'admin_form_add_db_img.php?id=' + id + '&p_img2=' + p_img2,
...
<div class="form-group">
    ...
    <div class="col-sm-10" align="left">
        ...
        <input name="a_name" type="text" id="name" required class="form-control col-sm-8" id="a_name"
...
<div class="form-group">
    <div class="col-sm-10" align="left">
        ...
        <input name="a_lastname" type="text" id="lastname" required class="form-control col-sm-8" id="a_lastname"
...
<div class="form-group">
    <div class="col-sm-10" align="left">
        ...
        <input name="a_tel" type="text" id="tel" required class="form-control col-sm-8" id="a_tel" value="<?=$tel; ?>"
...
<div class="form-group">
    <div class="col-sm-10" align="left">
        ...
        <input name="a_email" type="text" id="email" required class="form-control col-sm-8" id="a_email"
            value="<?=$email; ?>" placeholder="อีเมล" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6" align="right">
        <button type="submit" class="btn btn-success profile-edit-btn" id="submit-edit"> <span
