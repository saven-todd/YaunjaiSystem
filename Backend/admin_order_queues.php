        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                for (i = 0; i < order.length; i++) {
                    ...
                    const dateLive = currentdate.getFullYear() + "-" + addZero((currentdate
                    ...
                    const now = dateLive + " " + h + ":" + m + ":" + s;
                    const min = dateLive + " " + "00:00:00";

                    if (order[i].OrderDate > min && (order[i].accept_FK == 2 || order[i].accept_FK == 1)) {
